...
public class MsgTextRight extends RelativeLayout {
    ...
    public MsgTextRight(Context context) {
        super(context);
        initView();
    }

    public MsgTextRight(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public MsgTextRight(Context context, AttributeSet attrs, int defStyleAtrr) {
        super(context, attrs, defStyleAtrr);
        initView();
    }

    public void initView() {
        inflate(getContext(), R.layout.listitem_msg_text_right, this);
