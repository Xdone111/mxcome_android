...
public class Panel extends LinearLayout {
	...
	public Panel(Context context, AttributeSet attrs) {
		...
		mDuration = a.getInteger(R.styleable.Panel_animationDuration, 200);		// duration defaults to 200 ms
	...
	protected void onFinishInflate() {
		...
		mHandle = (ImageButton) findViewById(R.id.panelHandle);
		if (mHandle == null) {
	...
	private void postProcess() {
		...
		if (panelListener != null) {
			if (mIsShrinking) {
				...
				mHandle.setImageResource(R.mipmap.diary_right_switch);
			} else {
				panelListener.onPanelOpened(Panel.this);
				mHandle.setImageResource(R.color.trans);
			}
		}
	}
