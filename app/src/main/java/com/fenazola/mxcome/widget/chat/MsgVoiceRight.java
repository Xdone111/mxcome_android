...
public class MsgVoiceRight extends RelativeLayout {
    ...
    public MsgVoiceRight(Context context) {
        super(context);
        initView();
    }

    public MsgVoiceRight(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public MsgVoiceRight(Context context, AttributeSet attrs, int defStyleAtrr) {
        super(context, attrs, defStyleAtrr);
        initView();
    }

    public void initView() {
        inflate(getContext(), R.layout.listitem_msg_voice_right, this);
    ...
    public void setUserIcon(String photoUrl){
        Glide.with(getContext()).load(Constant.imageUrl + photoUrl).placeholder(R.mipmap.msg_default_icon).centerCrop().into(user_icon);
    }
    ...
    public void setUnread(boolean isShow){
        if (isShow){
