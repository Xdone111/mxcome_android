 ...
 *
 */
public class CommonBDialog extends Dialog {
	...
	public CommonBDialog(Context context) {
		super(context, com.zss.library.R.style.CommonDialog);
		setContentView(R.layout.common_dialog_b);
		setCanceledOnTouchOutside(true);
		initView();
	}

	public CommonBDialog(Context context, CharSequence title, CharSequence content) {
		this(context);
		common_tv_title.setText(title);
		common_tv_context.setText(content);
	}

	public CommonBDialog(Context context, int title, int content) {
