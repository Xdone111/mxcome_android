...
public class BindWechatFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void initView() {
        super.initView();
        isNeed = (boolean) getArguments().get(Constant.key1);
        entry = (WechatEntry) getArguments().get(Constant.key2);
        ...
        if (isNeed) {
            ...
            eWidget4.setVisibility(View.GONE);
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        eWidget4.setLeftImageResource(R.mipmap.register_phone);
...
//                addFragment(fragment);
    ...
    public void doRegister(String tel, String verifyCode, String pwd, String nickName) {
        ...
        map.put("wx_openid", entry.getOpenid());
        map.put("tel", tel);
        ...
        map.put("nickname", entry.getNickname());
        map.put("sex", entry.getSex());
        map.put("language", entry.getLanguage());
        map.put("province", entry.getProvince());
        map.put("country", entry.getCountry());
        map.put("headimgurl", entry.getHeadimgurl());
        map.put("unionid", entry.getUnionid());
        String url = Constant.newBaseUrl+"weixin/userBinding";
        if (!isNeed) {
            url =Constant.baseUrl +"appApi/appRegister.do";
        }
        //TODO
