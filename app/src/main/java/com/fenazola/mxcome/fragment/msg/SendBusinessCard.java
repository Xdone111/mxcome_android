 ...
 * 发布名片
 */
public class SendBusinessCard extends Dialog implements View.OnClickListener {
    ...
    public SendBusinessCard(Activity context) {
    ...
    public void initData() {
        ...
        mAdapter = new CommonAdapter<String>(mContext, R.layout.layout_add_group_item) {
            @Override
