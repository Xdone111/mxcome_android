...
public class DesignerCommentFragment extends BaseFragment implements View.OnClickListener {
    /**
     * 好评中评差评图片
     */
    ...
    public int getLayoutResId() {
        return R.layout.fragment_designer_comment;
    }
    ...
    public void initView() {
        ...
        Glide.with(getActivity()).load(workerListEntry.getPic()).diskCacheStrategy(DiskCacheStrategy.ALL).error(R.mipmap.designer_photo).into(photoIv);
    ...
    public void setTopBar() {
        ...
        toolbar.setLeftImage(R.mipmap.back_black);
    }
    ...
    public void initChangeComments(int index) {
        ...
        if (index == 0) {
            goodIsCheck = 1;
            goodIv.setImageResource(R.mipmap.good_comment_yellow);
            goodTv.setTextColor(getColor(R.color.colorYellow));
        } else if (index == 1) {
            midIsCheck = 1;
            commentsIv.setImageResource(R.mipmap.comment_medium_yellow);
            commentsTv.setTextColor(getColor(R.color.colorYellow));
        } else {
            lowIsCheck = 1;
            badIv.setImageResource(R.mipmap.comment_negative_yellow);
            badTv.setTextColor(getColor(R.color.colorYellow));
        }
